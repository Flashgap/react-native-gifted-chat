...
let MIN_INPUT_TOOLBAR_HEIGHT = 44;
...
class GiftedChat extends React.Component {
    ...
    setMinInputToolbarHeight(height) {
        if (height !== MIN_INPUT_TOOLBAR_HEIGHT) {
            MIN_INPUT_TOOLBAR_HEIGHT = height;
            this.resetInputToolbar();
        }
    }

    getMinInputToolbarHeight() {
        const minInputToolbarHeight = this.props.minInputToolbarHeight
            ? this.props.minInputToolbarHeight
            : MIN_INPUT_TOOLBAR_HEIGHT;
        return this.props.renderAccessory ? minInputToolbarHeight + this.props.accessory.height : minInputToolbarHeight;
    }
...
GiftedChat.defaultProps = {
    ...
    maxInputLength: null,
    accessory: { height: 44, isTop: false }
};
...
GiftedChat.propTypes = {
    ...
    accessory: React.PropTypes.shape({
